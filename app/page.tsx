            ...
            >
                ...
                <div className="flex flex-col items-center mb-10">
                    <motion.div
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full max-w-[500px] h-40 flex items-center justify-center mb-0 cursor-pointer overflow-hidden rounded-3xl border-[8px] border-[#FCFBF6] shadow-[0_20px_40px_rgba(62,58,51,0.05)]"
                    >
                        {logoUrl ? (
